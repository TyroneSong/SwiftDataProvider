...
// MARK: - EnvironmentKey / EnvironmentValues ⚡️
public struct DataHandlerKey: EnvironmentKey {
    public static var defaultValue: @Sendable () async -> DataHandler? = { nil }
}
...
public struct MainActorDataHandlerKey: EnvironmentKey {
    public static var defaultValue: @Sendable @MainActor () async -> DataHandler? = { nil }
}
